...
class PetFriends:
    ...
    def get_api_key(self, email: str, password: str) -> json:
        ...
        с уникальным ключом пользователя, полученным по указанным email и password."""
    ...
    def add_photo_of_pet(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """Метод отправляет на сервер данные о добавлении (изменении) фотографии питомца и возвращает статус
